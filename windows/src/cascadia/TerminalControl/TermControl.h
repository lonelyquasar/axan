...
#pragma endregion
        ...
        // axan M11: input-safety guard — called by the host after the confirm dialog.
        void ConfirmPendingInterrupt();
        ...
        til::typed_event<IInspectable, IInspectable> OutputIdle; // axan M5: re-raised from ControlCore for the sidebar
        til::typed_event<IInspectable, IInspectable> ShowCtrlCInputGuard; // axan M11: input-safety guard
    ...
    private:
        ...
        bool _interruptGuardPending{ false }; // axan M11: a Ctrl+C confirm dialog is in flight
