...
namespace winrt::Microsoft::Terminal::Control::implementation
{
    ...
    public:
        ...
        // axan M11: input-safety guard policy/enforcement seam.
        bool ShouldGuardInterrupt() const;
        void SendInterrupt();
        bool InputSafetyGuardEnabled() const noexcept;
        void InputSafetyGuardEnabled(bool value) noexcept;
...
#pragma endregion
        ...
        // axan M11: input-safety guard (the Ctrl+C-wipes-unsubmitted-input bug).
        // _hasUnsubmittedInput is the coarse "input since last newline" heuristic
        // (rearchitecture.md §6): set by any printable char typed or pasted, cleared
        // on a submitted line (Enter) or an interrupt. _inputSafetyGuard is the policy
        // toggle — default-on; user-facing setting deferred to M14's Settings UI.
        bool _hasUnsubmittedInput{ false };
        bool _inputSafetyGuard{ true };
