...
static constexpr std::string_view ToggleSidebarKey{ "toggleSidebar" }; // axan M8d: cycle the session sidebar
static constexpr std::string_view FocusSidebarKey{ "focusSidebar" }; // axan #429: move keyboard focus into the session sidebar
    ...
    winrt::hstring ActionAndArgs::GenerateName(const winrt::Windows::ApplicationModel::Resources::Core::ResourceContext& context) const
    {
        ...
        static const auto GeneratedActionNames = []() {
            return std::unordered_map<ShortcutAction, wil::zwstring_view>{
                ...
                { ShortcutAction::FocusSidebar, USES_RESOURCE(L"FocusSidebarCommandKey") },
            };
        }();
