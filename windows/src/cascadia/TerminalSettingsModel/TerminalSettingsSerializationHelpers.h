...
// axan M8: session-sidebar collapse state + minimized width step (persisted in state.json).
JSON_ENUM_MAPPER(::winrt::Microsoft::Terminal::Settings::Model::SidebarState)
{
    JSON_MAPPINGS(3) = {
        pair_type{ "expanded", ValueType::Expanded },
        pair_type{ "minimized", ValueType::Minimized },
        pair_type{ "collapsed", ValueType::Collapsed },
    };
};

JSON_ENUM_MAPPER(::winrt::Microsoft::Terminal::Settings::Model::SidebarMinimizedSize)
{
    JSON_MAPPINGS(3) = {
        pair_type{ "small", ValueType::Small },
        pair_type{ "medium", ValueType::Medium },
        pair_type{ "large", ValueType::Large },
    };
};
