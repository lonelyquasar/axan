...
#define MTSM_APPLICATION_STATE_FIELDS(X)                                                                                                                                  \
    ...
    X(FileSource::Shared, winrt::Microsoft::Terminal::Settings::Model::SidebarState, SidebarState, "sidebarState", winrt::Microsoft::Terminal::Settings::Model::SidebarState::Expanded) \
    X(FileSource::Shared, winrt::Microsoft::Terminal::Settings::Model::SidebarMinimizedSize, SidebarMinimizedSize, "sidebarMinimizedSize", winrt::Microsoft::Terminal::Settings::Model::SidebarMinimizedSize::Medium) \
    X(FileSource::Shared, int32_t, SidebarExpandedWidth, "sidebarExpandedWidth", 260)
